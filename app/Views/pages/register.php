...
<div class="contact-area d-flex align-items-center" style="background-image: url(assets/images/lego-3625194_1280.png);background-size:cover;height:550px">
    <form action="regsiter/checkregsiter" method="post" style="margin:auto">
        <div>
            <div class="page-title text-center">
                ...
                if($session->get('success')){
                    ...
                    if(isset($data)){
                        echo "<div class='col-12 mb-1 mt-1 text-danger'>Account registration failed, please check the information again</div>";
                    }
                }
                ?>
            </div>
            ...
            <div class="col-12 mb-3">
                <label for="state">Re-Enter Password</label>
                <input type="password" class="form-control" name="customer_repassword" placeholder="Password" style="width: 500px;" required id="password" value="">
                <i style="margin-left: -30px;position:absolute;margin-top:-25px;right:30px; cursor: pointer;" class="far fa-eye" id="togglePassword"></i>
            </div>
            <div class="col-12">
                <div class="custom-control custom-checkbox d-block mb-2">
                    <input type="checkbox" class="custom-control-input" required id="customCheck1">
                    <label class="custom-control-label" for="customCheck1">I agree terms and conitions</label>
                </div>                       
            </div>
            <div class="col-12 mr-1 text-right ">
                <a  href="/login"><h6 class="text-danger">Login</h6></a>
            </div>
            <button type="submit" style="margin-left:35%;" class="btn essence-btn">Register</a>
        </div>
    </form>
</div>
<script>
